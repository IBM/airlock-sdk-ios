    ...
    override func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 0 {
            ...
            if indexPath.row == 2 { // Process
                ...
                if let persentageCell = cell as? PercentageTableViewCell {
                ...
                if let verboseCell = cell as? PercentageTableViewCell {
                    verboseCell.isPrecentOn.isOn = stream.verbose
                }
            } else if indexPath.row == 5 {  //suspend processing
                if let suspendProcessCell = cell as? PercentageTableViewCell {
