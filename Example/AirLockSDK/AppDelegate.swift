...
//  AirLockSDK
//
//  Created by Gil Fuchs on 09/14/2016.
//  Copyright (c) 2016 Gil Fuchs. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    @objc private func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
