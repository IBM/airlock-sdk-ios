...
internal class AirlockNotificationsManager: NSObject {
    ...
    fileprivate func getJSUtils() -> String? {
        ...
        guard let jsUtilsStr = AirlockFileManager.readString(JS_UTILS_FILE_NAME_KEY) else {
            return nil
        }
    ...
    fileprivate func getContext() -> String? {
        ...
        guard let contextStr = AirlockFileManager.readString(LAST_CONTEXT_STRING_KEY) else {
            return nil
        }
