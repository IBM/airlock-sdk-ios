...
class ExperimentsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        var expsData = (searchController.isActive && searchController.searchBar.text != "") ? self.filteredExpsArray : self.expsArray
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        guard let ip = self.tableView.indexPath(for: cell) as? IndexPath else {
            return
        }
